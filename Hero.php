...
<section id="reviews">
    <div class="container">
      <div class="wrapper">
        <div class="header">
            <h2>Course.com Hero</h2>
          <h5>Ayo ikuti program menarik berikut ini!</h5>
        </div>
          ...
          <div class="card">
            <div class="header-card">
              ...
              <div class="name-address">
                <h4>Learn Golang: 5 Days with pofesional</h4>
                <p>Junior Level</p>
              </div>
            </div>
            <div class="desc">
                "Dalam program ini, peserta akan memiliki kesempatan unik untuk mempelajari secara mendalam tentang bahasa pemrograman Go, mendapatkan wawasan dan ketrampilan berharga."
            </div>
            <p>Rp.299k</p>
            <a href="beli.php" class="button">Daftar</a>
          </div>
          <div class="card">
            <div class="header-card">
              <img src="assets/user2.jpg" alt="" />
              <div class="name-address">
                <h4>Learn QA Aoutomation with Cypress</h4>
                <p>Middle Level</p>
              </div>
            </div>
            <div class="desc">
                "Dalam program intensif "Belajar QA Automation dengan Cypress," peserta akan menghadapi kesempatan yang unik untuk memperdalam pemahaman mereka tentang dunia otomasi pengujian perangkat lunak (QA) dengan menggunakan framework Cypress."
            </div>
            <p>Rp.599k</p>
            <a href="beli.php" class="button">Daftar</a>
          </div>
  ...
  <!-- FOOTER -->
  <div class="wrapper7" style="margin-top: 10%;">
    <section id="footer">
